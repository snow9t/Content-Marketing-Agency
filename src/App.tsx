    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      >
        ...
        <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-8 leading-[1.1] tracking-tight">
          ...
          <span className="text-blue-600">محرك نمو حقيقي</span>
        </h1>
...
const Process = () => {
  ...
  return (
    <section id="process" className="py-24 bg-blue-900 text-white overflow-hidden relative">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-800/50 skew-x-12 translate-x-32 -z-0" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">كيف نبدأ؟</h2>
          <p className="text-blue-200 text-xl">خطوات بسيطة تفصلك عن التميز الرقمي</p>
        </div>
        <div className="grid md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 left-full w-full h-px bg-blue-500/50 -translate-x-12" />
              )}
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-blue-500 rounded-full flex items-center justify-center mb-6 border-4 border-blue-800 shadow-lg">
                  {step.icon}
                </div>
